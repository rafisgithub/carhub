            ...
            <div class="row">
                <div class="col-12" data-aos="fade-in" data-aos-duration="1000" data-aos-delay="100">
                    ...
                    <div class="car--review">
                        <img src="{{ asset($ceoData->image) }}" alt="" />
                        <div>
                            <h4>{{ $ceoData->title }}</h4>
                            <p>
                               {!! $ceoData->content !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 mt_20" data-aos="fade-up" data-aos-duration="1000">
                            <div class="advantage--card">
                                <!-- icon  -->
                                <div class="icon">
                                    <img src="{{ asset($feature->image) }}" alt="" style="width:50px ;height: 50px " />
                                </div>
                                <h4>{{ $feature->title }}</h4>
                                <p>
                                    {!! $feature->content !!}
                        ...
                        <div class="tab-pane fade show active" id="pills-car-buy" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-lg-5 mt_30" data-aos="fade-up" data-aos-duration="1000">
                                    <!-- img--area   -->
                                    <div class="img--area">
                                        <img class="w-100" src="{{ asset( $buyingCar->image ) }}" alt="" />
                                    </div>
                                </div>
                                    ...
                                    <div class="car--contents">
                                        {!! $buyingCar->content !!}
                                            ...
                                            <div class="video--popup"
                                                style="background-image: url( asset( {{ $buyingCar->banner }} ) ;">
                                                <a href="{{ $buyingCar->url }}">
                        ...
                        <div class="tab-pane fade" id="pills-sell" role="tabpanel" aria-labelledby="pills-sell-tab"
                            ...
                            <div class="row">
                                <div class="col-lg-5 mt_30">
                                    <!-- img--area   -->
                                    <div class="img--area">
                                        <img class="w-100" src="{{ asset( $sellingCar->image ) }}"
                                            alt="" />
                                    </div>
                                </div>
                                <div class="col-lg-7 mt_30">
                                    <div class="car--contents">
                                        <h3>{{ $sellingCar->title }}</h3>
                                        <p>
                                            {!! $sellingCar->content !!}
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="pills-finalize" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-lg-5 mt_30">
                                    <!-- img--area   -->
                                    <div class="img--area">
                                        <img class="w-100" src="{{ asset( $finalizeTheSell->image ) }}"
                                            alt="" />
                                    </div>
                                </div>
                                <div class="col-lg-7 mt_30">
                                    <div class="car--contents">
                                        <h3>{{ $finalizeTheSell->title }}</h3>
                                            {!! $finalizeTheSell->content !!}
                                    </div>
                                </div>
                            </div>
                        </div>
