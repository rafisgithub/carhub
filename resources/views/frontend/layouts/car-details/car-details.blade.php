...
@section('content')
                      ...
                      <div class="row">
                        ...
                        >
                          <a href="#">
                            <img
                              class="w-100"
                               src=" {{ asset('frontend/assets') }}/images/car16.png"
                              alt=""
                            />
                          </a>
                        </div>
                        ...
                        >
                          <a href="#">
                            <img
                              class="w-100"
                               src=" {{ asset('frontend/assets') }}/images/car14.png"
                              alt=""
                            />
                          </a>
                        </div>
                        ...
                        >
                          <a href="#">
                            <img
                              class="w-100"
                               src=" {{ asset('frontend/assets') }}/images/car15.png"
                              alt=""
                            />
                          </a>
                        </div>
              ...
              >
                ...
                <div class="single--info">
                  <div class="icon">
                    ...
                    >
                      <path
                        d="M9.76255 22.2083L4.32422 16.7808"
                        stroke="#FD7F54"
                        stroke-opacity="0.47"
                        stroke-width="1.5"
                      ...
                      />
                      <path
                        d="M16.2383 3.79175L21.6766 9.21925"
                        stroke="#FD7F54"
                        stroke-width="1.5"
                        stroke-miterlimit="10"
                        stroke-linecap="round"
                ...
                <div class="single--info">
                  <div class="icon">
                    ...
                    >
                      <path
                        d="M18.5785 14.9717L15.2852 18.265"
                        stroke="#FD7F54"
                        stroke-width="1.5"
                        stroke-miterlimit="10"
                        stroke-linecap="round"
                      ...
                      />
                      <path
                        d="M7.42188 11.0284L10.7152 7.73511"
                        stroke="#FD7F54"
                        stroke-width="1.5"
                        stroke-miterlimit="10"
                        stroke-linecap="round"
        ...
        <div class="container">
          <div class="row">
            <div class="col-xxl-6 col-lg-5 mt_30">
              ...
              <div
                class="car-details-table--wrapper"
                data-aos="fade-up"
                data-aos-duration="1000"
              >
                <!-- title  -->
                ...
                <!-- highlights  -->
                <div
                  class="highlights details mt_65"
                  data-aos="fade-up"
                  data-aos-duration="1000"
                >
                  <h4>Highlights</h4>
                ...
                <!-- rent--history  -->
                <div
                  class="rent--history details mt_35"
                  data-aos="fade-up"
                  data-aos-duration="1000"
                >
                ...
                <!-- other items  -->
                <div
                  class="other--items details mt_35"
                  data-aos="fade-up"
                  data-aos-duration="1000"
                >
                ...
                <!-- ownership history  -->
                <div
                  class="ownership--history details mt_35"
                  data-aos="fade-up"
                  data-aos-duration="1000"
                >
                  ...
                  >
                    <div class="car--card">
                      <div class="img--area">
                        <img
                          class="w-100"
                           src=" {{ asset('frontend/assets') }}/images/car6.png"
                          alt=""
                        />
                      </div>
                      <div class="car--info">
                  ...
                  >
                    <div class="car--card">
                      <div class="img--area">
                        <img
                          class="w-100"
                           src=" {{ asset('frontend/assets') }}/images/car9.png"
                          alt=""
                        />
                      </div>
                      <div class="car--info">
                  ...
                  >
                    <div class="car--card">
                      <div class="img--area">
                        <img
                          class="w-100"
                           src=" {{ asset('frontend/assets') }}/images/car10.png"
                          alt=""
                        />
                      </div>
                      <div class="car--info">
                  ...
                  >
                    <div class="car--card">
                      <div class="img--area">
                        <img
                          class="w-100"
                           src=" {{ asset('frontend/assets') }}/images/car12.png"
                          alt=""
                        />
                      </div>
                      <div class="car--info">
      ...
      <section class="testimonial--area">
        <!-- section--title  -->
        <div
          class="section--title mb_95 text-center"
          data-aos="fade-in"
          data-aos-duration="1500"
        >
              ...
              <div class="col-md-12">
                <div class="input--group">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="zip"
                    placeholder="Enter veiled zip code"
                    required
                  />
                  <div class="invalid-feedback">
