                        ...
                        <div class="row">
                          ...
                          >
                            <a
                              ...
                              class="featured--car"
                              style="
                                background-image: url({{ asset('frontend/assets') }}/images/car1.png);
                              "
                            >
                              <h3>
                            ...
                            <div class="row">
                              ...
                              >
                                <a href="{{ route('car-details') }}">
                                  <img
                                    class="w-100"
                                    src=" {{ asset('frontend/assets') }}/images/car2.png"
                                    alt=""
                                  />
                                </a>
                              </div>
                              ...
                              >
                                <a href="{{ route('car-details') }}">
                                  <img
                                    class="w-100"
                                    src=" {{ asset('frontend/assets') }}/images/car3.png"
                                    alt=""
                                  />
                                </a>
                              </div>
                              ...
                              >
                                <a href="{{ route('car-details') }}">
                                  <img
                                    class="w-100"
                                    src=" {{ asset('frontend/assets') }}/images/car4.png"
                                    alt=""
                                  />
                                </a>
                              </div>
                              ...
                              >
                                ...
                                <!-- gallery  -->
                                <div class="gallery">
                                  <a href="{{ asset('frontend/assets') }}/images/car1.png"> </a>
                                  <a href="{{ asset('frontend/assets') }}/images/car2.png"> </a>
                                  <a href="{{ asset('frontend/assets') }}/images/car3.png"> </a>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-lg-6 mt_20">
                            <a
                              ...
                              class="featured--car"
                              style="
                                background-image: url({{ asset('frontend/assets') }}/images/car6.png);
                              "
                            >
                              <h3>
                                1987 Renault Alliance GTA Convertible Double
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                >
                  ...
                  <div class="car--card">
                    <div class="img--area">
                      <img class="w-100" src=" {{ asset('frontend/assets') }}/images/car5.png" alt="" />
                    </div>
                    <div class="car--info">
                      <div class="bid--info">
                        <p>
                      ...
                      <div class="car--model">
                        ...
                        <div class="card--footer">
                          ...
                          <a href="{{ route('car-details') }}" class="buttonv2 button"
                            >Place a Bid</a
                          >
                        </div>
                      </div>
                ...
                >
                  ...
                  <div class="car--card">
                    <div class="img--area">
                      <img class="w-100" src=" {{ asset('frontend/assets') }}/images/car9.png" alt="" />
                    </div>
                    <div class="car--info">
                      <div class="bid--info">
                        <p>
                ...
                >
                  ...
                  <div class="car--card">
                    <div class="img--area">
                      <img class="w-100" src=" {{ asset('frontend/assets') }}/images/car16.png" alt="" />
                    </div>
                    <div class="car--info">
                      <div class="bid--info">
                        <p>
                ...
                <div
                  class="col-12 text-center mt_70"
                  data-aos="fade-in"
                  data-aos-duration="1500"
                  data-aos-delay="100"
                >
