                ...
                <div class="owl-carousel hero--slider">
                    <div class="item">
                        <div class="slider--box">
                            <div class="row">
                                <div class="col-lg-6 mt_20" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                                    <a href="" class="featured--car" style="background-image: url({{ asset('frontend/assets') }}/images/car1.png);">
                                        <h3>
                                        ...
                                        <div class="more--info">
                                            <p>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 22 23" fill="none">
                                                    <path d="M10.9365 20.6231C5.97082 20.6231 1.94531 16.5975 1.94531 11.6319C1.94531 6.66613 5.97082 2.64062 10.9365 2.64062C15.9022 2.64062 19.9278 6.66613 19.9278 11.6319C19.9278 16.5975 15.9022 20.6231 10.9365 20.6231ZM10.9365 18.8248C14.9091 18.8248 18.1295 15.6044 18.1295 11.6319C18.1295 7.65928 14.9091 4.43887 10.9365 4.43887C6.96396 4.43887 3.74356 7.65928 3.74356 11.6319C3.74356 15.6044 6.96396 18.8248 10.9365 18.8248ZM11.8357 11.6319H15.4322V13.4301H10.0374V7.13624H11.8357V11.6319Z" fill="#B3BAC5" />
                                                </svg>
                                                2 day left
                                            </p>
                                ...
                                <div class="col-lg-6 slider-right-box">
                                    <div class="row">
                                        <div class="col-sm-6 mt_20" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                                            <a href="">
                                                <img class="w-100" src=" {{ asset('frontend/assets') }}/images/car2.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="col-sm-6 mt_20" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                                            <a href="">
                                                <img class="w-100" src=" {{ asset('frontend/assets') }}/images/car3.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="col-sm-6 mt_20" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                                            <a href="">
                                                <img class="w-100" src=" {{ asset('frontend/assets') }}/images/car4.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="col-sm-6 mt_20" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="700">
                        ...
                        <div class="slider--box">
                            <div class="row">
                                <div class="col-lg-6 mt_20">
                                    <a href="" class="featured--car" style="
                              ...
                              ">
                                ...
                                <div class="col-lg-6 slider-right-box">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 mt_20">
                                            <a href="">
                                                <img class="w-100" src=" {{ asset('frontend/assets') }}/images/car15.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="col-sm-6 mt_20">
                                            <a href="#" class="more--photos--box" id="morePhotosBox">
...
<section class="live--auctions--area">
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="car--info">
                        <div class="bid--info">
                            <p>
                                ...
                                {{ $allcar->auctionTime->start_time->diffInDays($allcar->auctionTime->end_time, false) }} day left
                            </p>
                            <p>
                                <span>Bid</span>
                                $ {{ $allcar->bit_price }}
                        ...
                        <div class="car--model">
                            <a href="{{ route('car.details',['id' => $allcar->id]) }}">{{ $allcar->model }}</a>
                            <p>
                                {{ $allcar->year }} | {{ $allcar->mileage }} miles | {{ $allcar->is_modified == 1 ? " Modified " : " Intake product " }}
                            </p>
                            <div class="card--footer">
                                <p>{{ $allcar->carCategory->category }} | {{ $allcar->carTransmission->transmission_type }}</p>
                                <a href="{{ route('car.details', ['id' => $allcar->id]) }}" class="buttonv2 button">Place a Bid</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 text-center mt_70" data-aos="fade-in" data-aos-duration="1500" data-aos-delay="100">
