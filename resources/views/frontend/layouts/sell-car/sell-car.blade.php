...
<main>
    ...
    <section class="cars--and--bids--area" style="background-image: url( {{ asset('frontend/assets') }}/car-and-bids-bg.png)">
      <div class="container">
        <!-- section--title  -->
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mt_20" data-aos="fade-in" data-aos-duration="1200" data-aos-delay="100">
            <!-- counter box  -->
          ...
          <div class="col-md-3 col-sm-6 mt_20" data-aos="fade-in" data-aos-duration="1200" data-aos-delay="200">
            <!-- counter box  -->
          ...
          <div class="col-md-3 col-sm-6 mt_20" data-aos="fade-in" data-aos-duration="1200" data-aos-delay="300">
            <!-- counter box  -->
            <div class="counter--box">
              <h4>
              ...
              <div class="row">
                <div class="col-md-6 mt_25">
                  ...
                  <div class="input--group">
                    ...
                    <input id="fname" type="text" placeholder="Enter your card name" required />
                    <!-- invalid message  -->
                    <p class="error"></p>
                  </div>
                </div>
                <div class="col-md-6 mt_25">
                  ...
                  <div class="input--group">
                    ...
                    <input id="num" type="text" placeholder="Enter your contact number" required />
                    <!-- invalid message  -->
                    <p class="error"></p>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-7 mt_25">
                  ...
                  <div class="input--group">
                    ...
                    <input id="mileage" type="text" placeholder="Enter your car mileage" required />
                    <!-- error message  -->
                    <p class="error"></p>
                  </div>
                </div>
                ...
                <div class="col-xl-4 mt_25">
                  ...
                  <div class="radio--box">
                    ...
                    <div class="radio--options">
                      <!-- input group  -->
                      <div class="input--group">
                        <input id="completely-stock" type="radio" name="isModified" required />
