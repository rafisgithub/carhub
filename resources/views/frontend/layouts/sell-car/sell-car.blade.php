...
@section('content')
    <main>
        ...
        <section class="sell--car--hero--area"
            style="background-image: url( {{ asset('frontend/assets') }}/sell-hero-bg.png)">
            <div class="container">
                <div class="row">
                    <div class="col-12">
        ...
        <div class="car--stepform--popup">
            ...
            <form action="{{ route('store.car.information') }}" id="sellForm" method="POST">
                @csrf
                <!-- from step  -->
                <div class="form--step">
                    <!-- your info  -->
                            ...
                            <div class="row">
                                <div class="col-md-6 mt_25">
                                    ...
                                    <div class="input--group">
                                        ...
                                        <input name="full_name" id="fname" type="text"
                                ...
                                <div class="col-md-6 mt_25">
                                    ...
                                    <div class="input--group">
                                        ...
                                        <input name="contact_number" id="num" type="text"
                        ...
                        <div class="info--box">
                            ...
                            <div class="vin--number">
                                ...
                                <div class="input--group mt_25">
                                    ...
                                    <input name="vin_number" id="vin-number" type="number"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 mt_25">
                                    ...
                                    <div class="input--group">
                                        ...
                                        <input name="mileage" id="mileage" type="text"
                                ...
                                <div class="col-xl-4 mt_25">
                                    ...
                                    <div class="radio--box">
                                        ...
                                        <div class="radio--options">
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="completely-stock" type="radio" name="is_modified"
                                                    value="false" />
                                            ...
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="modified" type="radio" name="is_modified"
                                                    value="true" />
                                                <label for="modified">
                                                    Modified
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                ...
                                <div class="col-xl-8 mt_25">
                                    ...
                                    <div class="radio--box">
                                        ...
                                        <div class="radio--options">
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input name="is_any_mechanical_cosmetic_flaws" id="sag-yes"
                                            ...
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input name="is_any_mechanical_cosmetic_flaws" id="sag-no"
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="sagnificant--textarea mt_25">
                                        ...
                                        <textarea name="details_of_any_mechanical_cosmetic_flaws" id="sagnificant-textarea" placeholder="Write here....."
                                            name="any_mechanical_cosmetic_flaws_details"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 mt_25">
                                    ...
                                    <div class="radio--box">
                                        ...
                                        <div class="radio--options">
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="locate-saudi" type="radio" name="location"
                                                    value="Saudi" />
                                            ...
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="locate-arab" type="radio" name="location"
                                                    value="Arab Amirat" />
                                ...
                                <div class="col-lg-8 mt_25">
                                    ...
                                    <div class="radio--box">
                                        ...
                                        <div class="radio--options">
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="sale-yes" type="radio" name="is_sales_elsewhere"
                                                    value="true" />
                                                <label for="sale-yes">
                                                    Yes
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                            ...
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="sale-no" type="radio" name="is_sales_elsewhere"
                                                    value="false" />
                                                <label for="sale-no">
                                                    No
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                ...
                                <div class="col-md-4 mt_25">
                                    ...
                                    <div class="radio--box">
                                        ...
                                        <div class="radio--options">
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="audi-car" type="radio" name="title_location"
                                                    value="Soudi Arabia" onclick="updateStates()" />
                                                <label for="audi-car">
                                                    Soudi
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="toyota" type="radio" name="title_location"
                                                    value="Dubai" onclick="updateStates()" />
                                                <label for="toyota">
                                                    Dubai
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-md-4 mt_25">
                                    ...
                                    <div class="radio--box">
                                        ...
                                        <div class="radio--options">
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="named-yes" type="radio" name="is_title_in_name"
                                                    value="true" />
                                                <label for="named-yes">
                                                    Yes
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                            ...
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="named-no" type="radio" name="is_title_in_name"
                                                    value="false" />
                                                <label for="named-no">
                                                    No
                                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                ...
                                <div class="col-12 mt_25">
                                    ...
                                    <div class="radio--box">
                                        ...
                                        <div class="radio--options">
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="minimum-yes" type="radio" name="is_set_min_price"
                                                    value="true" />
                                            ...
                                            <!-- input group  -->
                                            <div class="input--group">
                                                <input id="minimum-no" type="radio" name="is_set_min_price"
                                                    value="false" />
