<link
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href=" {{ asset('frontend/assets') }}/css/owl.carousel.min.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href=" {{ asset('frontend/assets') }}/css/nice-select.min.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href=" {{ asset('frontend/assets') }}/css/magnific-popup.min.css"
    />
