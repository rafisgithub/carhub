...
<link rel="stylesheet" type="text/css" href=" {{ asset('frontend/assets') }}/css/nice-select.min.css" />
...
<link rel="stylesheet" type="text/css" href=" {{ asset('frontend/assets') }}/css/ckeditor5.css" />
<!-- dropify -->
